...
<div class="bg-blue w-full h-screen font-sans">
            <div class="flex p-2 bg-blue-dark items-center">
                <div class="hidden md:flex justify-start">
                    <button @click="signOutAuth()" class="bg-blue-700 text-white w-20 h-10 rounded-lg mx-2 transition duration-300 hover:bg-blue-300 ">
                        exit
                    </button>
                    <button class="bg-blue-400 rounded p-2 font-bold text-white text-sm mr-2 flex">
                    ...
                    <input type="text" class="bg-blue-400 rounded p-2 text-white">
                </div>
